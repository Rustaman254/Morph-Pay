...
import {
    Search, Bell, LogOut, LayoutDashboard, Layers, Exchange, UserSquare, ListChecks,
    Wallet as WalletIcon, BarChart2, FileText, Settings
} from "lucide-react";
import { Input } from "@/components/ui/input";
import { toast } from "sonner";

// Menu Links (add keys/icons as needed)
const menuLinks = [
    { label: "Overview", key: "overview", href: "/", icon: LayoutDashboard },
    // { label: "Liquidity Pools", key: "liquidity", href: "/liquidity", icon: Layers },
    // { label: "Peer Exchange", key: "peer-exchange", href: "/peer-exchange", icon: Exchange },
...
export default function Header({ mode = "menu", active }: {mode: string, active: string}) {
                        ...
                        <AnimatePresence>
                            {openDropdown === "user" && (
                                ...
                                >
                                    ...
                                    <button onClick={handleSignOut} className="w-full flex items-center gap-2 px-3 py-2 rounded-full text-orange-600 hover:bg-orange-100 transition-colors mt-1">
                        ...
                        >
                            {menuLinks.map(link => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* White icon for the active link */}
