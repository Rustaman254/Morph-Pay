...
class Policies extends resource_1.APIResource {
    ...
    _createRule(policyID, params, options) {
        ...
        return this._client.post((0, path_1.path) `/v1/policies/${policyID}/rules`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([
                {
    ...
    _delete(policyID, params = {}, options) {
        ...
        return this._client.delete((0, path_1.path) `/v1/policies/${policyID}`, {
            ...options,
            headers: (0, headers_1.buildHeaders)([
                {
                    ...(privyAuthorizationSignature != null ?
    ...
    _deleteRule(ruleID, params, options) {
        ...
        return this._client.delete((0, path_1.path) `/v1/policies/${policy_id}/rules/${ruleID}`, {
            ...options,
            headers: (0, headers_1.buildHeaders)([
                {
                    ...(privyAuthorizationSignature != null ?
    ...
    _update(policyID, params, options) {
        const { 'privy-authorization-signature': privyAuthorizationSignature, ...body } = params;
        return this._client.patch((0, path_1.path) `/v1/policies/${policyID}`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([
                {
    ...
    _updateRule(ruleID, params, options) {
        ...
        return this._client.patch((0, path_1.path) `/v1/policies/${policy_id}/rules/${ruleID}`, {
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([
                {
    ...
    get(policyID, options) {
        return this._client.get((0, path_1.path) `/v1/policies/${policyID}`, options);
    }
    /**
    ...
    getRule(ruleID, params, options) {
        ...
        return this._client.get((0, path_1.path) `/v1/policies/${policy_id}/rules/${ruleID}`, options);
    }
}
