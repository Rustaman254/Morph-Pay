...
export interface User {
     ...
     */
    is_guest: boolean;
    linked_accounts: Array<User.LinkedAccountEmail | User.LinkedAccountPhone | User.LinkedAccountCrossApp | User.LinkedAccountAuthorizationKey | User.LinkedAccountCustomJwt | User.LinkedAccountAppleOAuth | User.LinkedAccountDiscordOAuth | User.LinkedAccountGitHubOAuth | User.LinkedAccountGoogleOAuth | User.LinkedAccountInstagramOAuth | User.LinkedAccountLinkedInOAuth | User.LinkedAccountSpotifyOAuth | User.LinkedAccountTiktokOAuth | User.LinkedAccountLineOAuth | User.LinkedAccountTwitterOAuth | User.LinkedAccountSmartWallet | User.LinkedAccountPasskey | User.LinkedAccountFarcaster | User.LinkedAccountTelegram | User.LinkedAccountEthereum | User.LinkedAccountEthereumEmbeddedWallet | User.LinkedAccountSolana | User.LinkedAccountSolanaEmbeddedWallet | User.LinkedAccountBitcoinSegwitEmbeddedWallet | User.LinkedAccountBitcoinTaprootEmbeddedWallet>;
...
export declare namespace User {
    ...
    interface LinkedAccountSmartWallet {
        address: string;
        first_verified_at: number | null;
        latest_verified_at: number | null;
    ...
    interface LinkedAccountEthereumEmbeddedWallet {
        id: string | null;
        address: string;
        chain_id: string;
        chain_type: 'ethereum';
    ...
    interface LinkedAccountSolanaEmbeddedWallet {
        id: string | null;
        address: string;
        chain_id: string;
        chain_type: 'solana';
    ...
    interface LinkedAccountBitcoinSegwitEmbeddedWallet {
        id: string | null;
        address: string;
        chain_id: string;
    ...
    interface LinkedAccountBitcoinTaprootEmbeddedWallet {
        id: string | null;
        address: string;
        chain_id: string;
...
export interface UserUnlinkLinkedAccountParams {
    handle: string;
    type: 'email' | 'wallet' | 'smart_wallet' | 'farcaster' | 'passkey' | 'phone' | 'google_oauth' | 'discord_oauth' | 'twitter_oauth' | 'github_oauth' | 'linkedin_oauth' | 'apple_oauth' | 'spotify_oauth' | 'instagram_oauth' | 'tiktok_oauth' | 'line_oauth' | 'custom_auth' | 'telegram' | 'cross_app' | 'guest';
    provider?: string;
}
